...
Eine Alternative zu den Papierbögen gab es aber doch: den Führerschein-Theorietrainer von Aral, den mir ein Klassenkamerad zum Glück empfohlen hatte. Durch diese tolle Seite, die es übrigens <a href="https://mein.aral.de/einstellungen/theorietrainer" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-0.5 transition hover:text-accent-600 dark:hover:text-accent-200">immer noch{% include icons/external-link.html %}</a> gibt, erleichterte die Vorbereitung auf die Prüfung ungemein.
